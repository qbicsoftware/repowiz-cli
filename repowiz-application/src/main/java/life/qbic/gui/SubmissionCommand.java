...
/**
 * Abstraction of command-line arguments that will be passed to {@link SubmissionApplication} at construction time.
 */
@Command(
   name="Submission",
   description="Application that helps to find a suitable repository to deposite research data for open access and to prepare the submission")
public class SubmissionCommand extends AbstractCommand {
